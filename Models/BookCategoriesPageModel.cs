...
namespace Onit_Diana_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Onit_Diana_Lab8Context context,Book book)
        {
        ...
        public void UpdateBookCategories(Onit_Diana_Lab8Context context,string[] selectedCategories, Book bookToUpdate)
        {
